...
if TYPE_CHECKING:
    ...
    # from callbacks import BaseCallback # eval predicted rewards
...
class RolloutBufferSamples(NamedTuple):
    ...
    returns: th.Tensor
    rewards: th.Tensor
    predicted_advantages: th.Tensor
    predicted_returns: th.Tensor
    predicted_rewards: th.Tensor    


class RewardFunctionSamples(NamedTuple):
    observations: th.Tensor
    actions: th.Tensor
    rewards: th.Tensor
